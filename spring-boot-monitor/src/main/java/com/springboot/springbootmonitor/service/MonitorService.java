package com.springboot.springbootmonitor.service;

import cn.hutool.core.date.BetweenFormater;
import cn.hutool.core.date.DateUtil;
import com.springboot.springbootmonitor.constant.ElAdminConstant;
import com.springboot.springbootmonitor.util.FileUtils;
import com.springboot.springbootmonitor.util.StringUtils;
...
public class MonitorService {
    ...
    public Map<String,Object> getServers(){
        ...
        try {
            ...
            resultMap.put("time", DateUtil.format(new Date(), "yyyy-MM-dd HH:mm:ss"));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return resultMap;
