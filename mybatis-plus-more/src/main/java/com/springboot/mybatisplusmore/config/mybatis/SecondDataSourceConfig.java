 ...
 */
@Configuration
@MapperScan(basePackages = "com.springboot.mybatisplusmore.mapper.second", sqlSessionTemplateRef = "secondSqlSessionTemplate")
public class SecondDataSourceConfig {
    ...
    public SecondDataSourceConfig(ObjectProvider<Interceptor[]> interceptorsProvider,
    ...
    @Bean("secondMybatisPlusProperties")
    @ConfigurationProperties(prefix = "mybatis-plus.second")
    ...
    public SqlSessionFactory secondSqlSessionFactory(@Qualifier("secondDataSource") DataSource dataSource,
                                                      @Qualifier("secondMybatisPlusProperties") MybatisPlusProperties mybatisPlusProperties) throws Exception {
